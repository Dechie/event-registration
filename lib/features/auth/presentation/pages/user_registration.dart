...
class _UserRegistrationPageState extends State<UserRegistrationPage>
  ...
  Widget _buildPasswordField() {
    return TextFormField(
      ...
      textInputAction: TextInputAction.next,
      onChanged: (_) => setState(() {}), // Trigger rebuild for password requirements
      decoration: InputDecoration(
        labelText: 'Password',
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildRequirementItem('Contains uppercase letter', RegExp(r'[A-Z]').hasMatch(password)),
          _buildRequirementItem('Contains lowercase letter', RegExp(r'[a-z]').hasMatch(password)),
          _buildRequirementItem('Contains number', RegExp(r'[0-9]').hasMatch(password)),
          _buildRequirementItem('Contains special character', RegExp(r'[!@#$%^&*(),.?":{}|<>]').hasMatch(password)),
        ],
      ),
    );
  }
      ...
      builder: (context, state) {
        ...
        return SizedBox(
          ...
          child: ElevatedButton(
            onPressed: (isLoading || !_acceptTerms) ? null : _handleRegistration,
