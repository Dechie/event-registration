import 'package:event_reg/features/splash/lib/features/splash/data/models/auth_status.dart' show AuthStatus, UserType;
...
class AuthLocalDataSourceImpl implements AuthLocalDataSource {
  ...
  Future<void> saveAuthStatus(AuthStatus authStatus) async {
    ...
    await sharedPreferences.setString(_userTypeKey, authStatus.userType.toString());
