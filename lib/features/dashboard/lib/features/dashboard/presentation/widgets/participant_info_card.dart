        ...
        child: Column(
          ...
          children: [
            ...
            _buildInfoSection(context, 'Personal Information', [
              ...
              _InfoItem('Date of Birth', participant.dateOfBirth?.toLocal().toString().split(' ')[0] ?? 'Not specified'),
              _InfoItem('Nationality', participant.nationality ?? 'Not specified'),
            ...
            _buildInfoSection(context, 'Professional Information', [
              ...
              _InfoItem('Department', participant.department ?? 'Not specified'),
              _InfoItem('Industry', participant.industry),
              _InfoItem('Years of Experience', '${participant.yearsOfExperience ?? 0} years'),
            ]),
          ],
        ),
      ),
