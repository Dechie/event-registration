...
abstract class DashboardLocalDataSource {
  ...
  Future<void> cacheParticipantDashboard(String email, ParticipantDashboard dashboard);
...
class DashboardLocalDataSourceImpl implements DashboardLocalDataSource {
  ...
  Future<ParticipantDashboard?> getCachedParticipantDashboard(
    ...
    final jsonString = sharedPreferences.getString('$_participantDashboardKey$email');
    if (jsonString != null) {
      final json = jsonDecode(jsonString) as Map<String, dynamic>;
